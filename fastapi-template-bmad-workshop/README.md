...
1. Clone the template to a working directory of your choice (this directory is just a guide — your real work happens in the clone):
   ...
   ```bash
   git clone https://github.com/fastapi/full-stack-fastapi-template.git fastapi-template-bmad
   cd fastapi-template-bmad
   git checkout -b workshop-bmad   # branch off so your work commits cleanly
   ```
